...
public class InterfaceJuego {
    ...
    public void instruccionesJuego(){
        ...
        System.out.println("- Primeros indicas la coordenada para la fila que va desde la posición 0 hasta la posición 2, " +
                "añades un espacio, y después la coordenada para la columna, que empieza en la posición 0 hasta " +
                "la posición 2.");
